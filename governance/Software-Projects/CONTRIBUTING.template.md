...
* The **Lead Maintainer** is the project's interface with the FINOS team and Board. They are responsible for communicating to the FINOS Governing Board and wider FINOS Community on behalf of the project. The Lead Maintainer is elected by a vote of the Maintainers. 
