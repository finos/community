...
### Security Scanning
In order to consolidate processes and tools around security vulnerabilities management, FINOS have shared a [guidelines around responsible disclosure for security vulnerabilities](/docs/governance/Software-Projects/Security-Vulnerabilities-Responsible-Disclosure-Policy) and tools that can be used to automate code scanning, you can read more on the <a href={useBaseUrl('/docs/development-infrastructure/code-validation/intro')}>code validation page</a>. FINOS also provides a collection of Github Action that can be used on your repositories, checkout the [code scanning project](https://github.com/finos/code-scanning).
