...
The [docusaurus workflow](https://github.com/finos/open-developer-platform/blob/master/.github/workflows/docusaurus.yml.deprecated) defines a GitHub Action that automatically builds the Docusaurus website after any commit.
...
All participants in the FINOS Slack are subject to the [LF Antitrust Policy](https://www.linuxfoundation.org/antitrust-policy/), the [FINOS Community Code of Conduct](https://www.finos.org/code-of-conduct) and all other [FINOS policies](/docs/governance/intro#policies). 
...
5. [DEPRECATED] Action [`.github/workflows/meetings.yml`](https://github.com/finos/open-developer-platform/blob/master/.github/workflows/meetings.yml.deprecated) defined
...
If a project team wishes to contact the FINOS team the can reach out via the [help@finos.org](mailto:help@finos.org). Projects can also directly email board@finos.org if they wish to escalate directly to the Governing Board.
