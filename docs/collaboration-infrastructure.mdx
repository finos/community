...
In order to collaborate in a FINOS project, the first thing is to get a GitHub.com account and sign the FINOS [Contributor License Agreement (CLA)](/docs/governance/Software-Projects/contribution-compliance-requirements); this document will walk you through access control and permissions that are enforced on FINOS GitHub properties.
