...
4. Issue template [`.github/ISSUE_TEMPLATE/Meeting.md`](https://github.com/finos/software-project-blueprint/blob/main/.github/ISSUE_TEMPLATE/meeting-minutes.yml) defined
