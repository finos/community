...
In order to contribute to and collaborate on a FINOS project, you will need to [create a GitHub.com account](https://github.com/signup) and meet the FINOS [contribution requirements](/docs/governance/Software-Projects/contribution-compliance-requirements) for your project (for example DCO or CLA); this document will walk you through access control and permissions that are enforced on FINOS GitHub properties.
...
## Access Control
All repositories managed by the Foundation are public. As a result, anyone can:
...
Any GitHub user who meets [FINOS contribution requirements](/docs/governance/Software-Projects/contribution-compliance-requirements) for their project (such as DCO or CLA coverage) can also:
...
[FINOS uses GitHub Teams](https://github.com/orgs/finos/teams) to manage each project's committer team. These teams are the only groups allowed to make direct changes to project repositories.
...
Assuming that you have read our [Contribution Requirements](/docs/governance/Software-Projects/contribution-compliance-requirements) and have the appropriate contributor coverage for your project (for example a [CLA](/docs/governance/Software-Projects/easycla) where your repository uses CLA), you can request to be invitated to [FINOS GitHub Organization](https://github.com/orgs/finos/people) by emailing your GitHub username to [help@finos.org](mailto:help@finos.org).
...
A build pipeline converts source code into deployable artifacts produced by the project team and hosted in GitHub. Reliable builds are essential because they can trigger automated tasks such as versioning, testing, quality checks, and compliance reporting.
...
The project blueprint comes with a pre-definite website that is built using Docusaurus (3.x) and served via Netlify to a custom finos.org subdomain.
