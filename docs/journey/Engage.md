...
- 5spot — [5spot@lists.finos.org](mailto:5spot+subscribe@lists.finos.org)
- AI Evaluation Framework — [ai-evals-framework@lists.finos.org](mailto:ai-evals-framework+subscribe@lists.finos.org)
- AI Governance Framework — [ai-governance-framework@lists.finos.org](mailto:ai-governance-framework+subscribe@lists.finos.org)
- AI Readiness SIG — [ai-readiness@finos.org](mailto:ai-readiness+subscribe@finos.org)
- AI Reference Architecture Library — [ai-reference-architecture-library@lists.finos.org](mailto:ai-reference-architecture-library+subscribe@lists.finos.org)
- Applied GenAI — [applied-genai@lists.finos.org](mailto:applied-genai+subscribe@lists.finos.org)
...
- Distinguished Engineer Community — [distinguished-engineer-community@lists.finos.org](mailto:distinguished-engineer-community+subscribe@lists.finos.org)
- FDC3 Sail — [fdc3-sail@lists.finos.org](mailto:fdc3-sail+subscribe@lists.finos.org)
...
- Fluxnova — [fluxnova@lists.finos.org](mailto:fluxnova+subscribe@lists.finos.org)
...
- Konspekt — [konspekt-general@lists.finos.org](mailto:konspekt-general+subscribe@lists.finos.org)
...
- Open Resource Broker — [open-resource-broker@lists.finos.org](mailto:open-resource-broker+subscribe@lists.finos.org)
- OpenGRIS — [opengris@lists.finos.org](mailto:opengris+subscribe@lists.finos.org)
...
- SDLC Framework — [sdlc-framework@lists.finos.org](mailto:sdlc-framework+subscribe@lists.finos.org)
...
- Vuu Announcements — [vuu-announce@lists.finos.org](mailto:vuu-announce+subscribe@lists.finos.org)
- Vuu Discussions — [vuu-discussion@lists.finos.org](mailto:vuu-discussion+subscribe@lists.finos.org)
- Vuu Questions — [vuu-questions@lists.finos.org](mailto:vuu-questions+subscribe@lists.finos.org)
