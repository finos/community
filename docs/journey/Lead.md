...
FINOS strong encourages projects to have multiple maintainers from multiple organizations: in fact having multiple maintainers is a pre-requisite for the [Graduation](https://community.finos.org/docs/governance/Software-Projects/Project-Lifecycle#Graduated) project [lifecycle maturity level](https://community.finos.org/docs/governance/Software-Projects/project-lifecycle).
