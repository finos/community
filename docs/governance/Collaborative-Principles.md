...
FINOS maintains policies and procedures for ensuring that all contributed code is appropriately licensed. Depending on the project, contributors use DCO or CLA; where a project uses CLA, [EasyCLA](Software-Projects/easycla) flags contributions that are not yet covered. When EasyCLA flags a pull request, project maintainers should not merge the pull request until the contributor is properly covered. See our [Contribution Requirements](Software-Projects/contribution-compliance-requirements) for more information.
