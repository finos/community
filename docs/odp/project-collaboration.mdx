...
| | | Submit a code change via Pull Request (flagged by the <a href={useBaseUrl('/docs/odp/development-infrastructure/code-validation/intro')}>FINOS CLA bot</a>)
...
| | | Submit a code change via Pull Request (validated by the <a href={useBaseUrl('/docs/odp/development-infrastructure/code-validation/intro')}>FINOS CLA bot</a>) |
...
If you want to add a website to an existing project, checkout the <a href={useBaseUrl('/docs/odp/development-infrastructure/project-documentation')}>ODP Project Documentation</a>; if you are starting a project from scratch, checkout the [FINOS project blueprint](#finos-project-blueprint).
...
2. Read our <a href={useBaseUrl('/docs/odp/development-infrastructure/project-documentation')}>getting started guide</a> to understand more about Docusaurus
...
If a project team wishes to contact the FINOS team the can reach out via the [help@finos.org](mailto:help@finos.org). Projects can also go directly email at board@finos.org if they wish to escalate directly to the Governing Board.
