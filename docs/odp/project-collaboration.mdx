...
In order to collaborate in a FINOS project, the first thing is to get a GitHub.com account and sign the FINOS [Contributor License Agreement (CLA)](https://finosfoundation.atlassian.net/wiki/spaces/FINOS/pages/75530375/Contribution+Compliance+Requirements#ContributionComplianceRequirements-ContributorLicenseAgreement); this document will walk you through access control and permissions that are enforced on FINOS GitHub properties.
...
| GitHub user covered by [CLA](https://finosfoundation.atlassian.net/wiki/spaces/FINOS/pages/75530375/Contribution+Compliance+Requirements#ContributionComplianceRequirements-ContributorLicenseAgreement) | Read | Become a member of the GitHub FINOS Organization |
...
Please note, the term [FINOS Members](https://finos.org/members) normally refers to the firms that sit on the FINOS Board and provide industrial and financial support to the foundation. Whereas, [GitHub FINOS Organization Members](https://github.com/orgs/finos/people) are individuals, represented by a [GitHub Profile](https://docs.github.com/en/github/setting-up-and-managing-your-github-profile/about-your-profile) and a signed FINOS [CLA](https://finosfoundation.atlassian.net/wiki/spaces/FINOS/pages/75530375/Contribution+Compliance+Requirements#ContributionComplianceRequirements-ContributorLicenseAgreement).

### Becoming GitHub FINOS Organization member
Assuming that you have read our [Contribution Compliance Requirements](https://finosfoundation.atlassian.net/wiki/spaces/FINOS/pages/75530375/Contribution+Compliance+Requirements) and have a [CLA](https://finosfoundation.atlassian.net/wiki/spaces/FINOS/pages/75530375/Contribution+Compliance+Requirements#ContributionComplianceRequirements-ContributorLicenseAgreement) signed with FINOS, you can request invitation to [FINOS GitHub Organization](https://github.com/orgs/finos/people) by emailing your GitHub username to [help@finos.org](mailto:help@finos.org).

FINOS uses [GitHub Actions](https://docs.github.com/en/actions) to automatically track new GitHub users (we have on file) which are covered by a [CLA](https://finosfoundation.atlassian.net/wiki/spaces/FINOS/pages/75530375/Contribution+Compliance+Requirements#ContributionComplianceRequirements-ContributorLicenseAgreement), and automatically sends out an invitation to join the FINOS GitHub org.

The source code is part of the FINOS [Project Quality & Compliance Action](https://github.com/finos/open-developer-platform/blob/master/.github/workflows/project-compliance-quality.yml).
...
1. Direct commits are not validated, as they cannot be blocked (ie, if [CLA](https://finosfoundation.atlassian.net/wiki/spaces/FINOS/pages/75530375/Contribution+Compliance+Requirements#ContributionComplianceRequirements-ContributorLicenseAgreement) is not in place)
...
1. Confirming that the person providing the contribution has a Contributor Licensing Agreement in place with the Foundation (though [EasyCLA](https://github.com/maoo/community/blob/migrate-wiki-contents/governance/Software-Projects/EasyCLA.md) will run an automatic scan of all Pull Requests).
