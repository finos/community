...
2. Read our <a href={useBaseUrl('/docs/odp/docs/development-infrastructure/project-documentation')}>getting started guide</a> to understand more about Docusaurus
