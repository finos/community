...
# Welcome
Welcome to the FINOS Maintainers Cheatsheet, the guide for new and experienced [FINOS Maintainers](/CONTRIBUTING.template.md#roles) on engaging with the [FINOS Community](https://www.finos.org/get-involved), [FINOS Team](https://www.finos.org/team) and [FINOS Governing Board](https://www.finos.org/governing-board) to drive project success.

## About FINOS
[FINOS](https://finos.org) is part of [The Linux Foundation](https://linuxfoundation.org) and has the mission to enable a global community to create open source solutions for financial services. The [FINOS Knowledge Base](https://www.finos.org/knowledge-base) contains helpful resources on FINOS, the FINOS community and FINOS projects. Learn more in the [FINOS Governance](/docs/governance/intro#foundation-governance) and email [help@finos.org](mailto:help@finos.org) with questions or suggestions.

## FINOS Projects and Special Interest Groups (SIGs)

FINOS [Open Source Software projects](/docs/governance/intro#open-source-software-projects), [Open Standards projects](/docs/governance/intro#open-standard-projects), and [Special Interest Groups (SIGs)](/docs/governance/intro#special-interest-groups) are at the very core of FINOS' mission to accelerate the use and development of open source software, standards, and practices to solve common challenges and drive innovation within the financial services industry. 
...
Each FINOS project and SIG has a community of [participants](/CONTRIBUTING.template.md#roles), also referred to as "contributors", and [maintainers](https://github.com/finos/software-project-blueprint/blob/main/CONTRIBUTING.md#roles). 
