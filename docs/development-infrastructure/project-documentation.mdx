...
After experimenting with various tools, we have selected Docusaurus (and GitHub Pages) as the best choice. Here’s why:
...
Given the significant adoption of Docusaurus within FINOS projects, it has become our go-to solution for building project documentation websites. If you're just getting started, use the [FINOS project blueprint](https://github.com/finos/project-blueprint) repository template to get started which includes a built-in Docusaurus website.
