...
## About FINOS
[FINOS](https://finos.org) is part of [The Linux Foundation](https://linuxfoundation.org) and has the mission to enable a global community to create open source solutions for financial services. The [FINOS Knowledge Base](https://www.finos.org/knowledge-base) contains helpful resources on FINOS, the FINOS community and FINOS projects. Learn more in the [FINOS Governance](/docs/governance) and email [help@finos.org](mailto:help@finos.org) with questions or suggestions.

## FINOS Projects and Special Interest Groups (SIGs)

FINOS [Open Source Software projects](/docs/governance/#open-source-software-projects), [Open Standards projects](/docs/governance/#open-standard-projects), and [Special Interest Groups (SIGs)](/docs/governance/#special-interest-groups) are at the very core of FINOS' mission to accelerate the use and development of open source software, standards, and practices to solve common challenges and drive innovation within the financial services industry. 
...
FINOS Standards projects can also have [**editors**](https://github.com/finos/standards-project-blueprint/blob/main/GOVERNANCE.md#1-roles).
...
| **Run Project Meetings** | Project maintainers are welcome to engage with their project community through project meetings. If they choose to do so, maintainers are responsible for creating meeting agendas and publishing meeting minutes. <ul><li>Email [help@finos.org](mailto:help@finos.org) for LFX PCC access, then [schedule and run meetings per FINOS Meeting Procedures](/docs/governance/meeting-procedures).</li><li>[Publish the agenda and a link to the PCC AI summary from a GitHub Issue.](/docs/collaboration-infrastructure#meeting-minutes)</li></ul> |
