...
FINOS [Open Source Software projects](/docs/governance/intro#open-source-software-projects), [Open Standards projects](/docs/governance/#open-standard-projects), and [Special Interest Groups (SIGs)](/docs/governance/intro#special-interest-groups) are at the very core of FINOS' mission to accelerate the use and development of open source software, standards, and practices to solve common challenges and drive innovation within the financial services industry. 
