...
**_All_ contributions to _all_ projects hosted by [FINOS](https://www.finos.org/) must be made with a [Foundation CLA](/docs/governance/Software-Projects/easycla) in place, and there are [additional legal requirements](/docs/governance/Software-Projects/contribution-compliance-requirements) that must also be met.**
