...
| Morphir   | Incubating       | <ul><li>Open Reg Tech: using Morphir as the open-source lingua franca across a number of similar initiatives.</li><li>Collaboration with Legend, especially towards Open Reg Tech.</li><li>Collaboration with other FINOS members (ISDA / Rosetta) and prospects (Microsoft, data vendors,...)</li></ul> | @agitana      | [Repo](https://github.com/finos/morphir) |
